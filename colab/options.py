...
parser.add_argument('--rgb_root', type=str, default='/content/dataset/RGBD_for_train/RGB/', help='the training rgb images root')
parser.add_argument('--depth_root', type=str, default='/content/dataset/RGBD_for_train/depth/', help='the training depth images root')
parser.add_argument('--gt_root', type=str, default='/content/dataset/RGBD_for_train/GT/', help='the training gt images root')

parser.add_argument('--test_rgb_root', type=str, default='/content/dataset/test_in_train/RGB/', help='the test rgb images root')
